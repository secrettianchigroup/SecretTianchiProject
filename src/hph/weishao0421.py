...
class solution():
    def __init__(self, evalOrTest='eval'):
        self.n_fold = 5
        self.random_seed = 1
        self.XGBbestNumRounds = 717
        self.LGBMbestNumRounds = 1475
        self.treeNum = 3000
    ...
    def datafilter(self, ad_data):
        ...
        # '''
        result = result.drop(
            ['item_category_list', 'item_property_list', 'is_trade', 'predict_category_property', 'time',
             'instance_id'], axis=1)
    ...
    def modelTest(self, data, modelChoice):
        writefileName = 'result/20180421.csv'
